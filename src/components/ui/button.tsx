  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium ring-offset-background transition-smooth focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        hero: "medical-gradient text-white hover:shadow-medium transform hover:scale-105 font-semibold",
        healing: "healing-gradient text-white hover:shadow-medium transform hover:scale-105 font-semibold",
        appointment: "bg-primary text-primary-foreground hover:bg-primary-hover shadow-medium transform hover:scale-105 font-semibold",
        nav: "text-foreground hover:text-primary transition-smooth hover:bg-accent/50",
      },
      size: {
